  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-end gap-2 mb-4 flex-wrap">
        ...
        className="inline-flex items-center rounded-sm bg-emerald-400 px-4 py-2 font-semibold text-white hover:bg-emerald-500"
      >
       お問い合わせ一覧
      </Link>
      <Link
      href="/admin/products/register"
      className="inline-flex items-center rounded-sm bg-indigo-500 px-4 py-2 font-semibold text-white hover:bg-indigo-600"
      >
       商品登録
      </Link>
</div>
